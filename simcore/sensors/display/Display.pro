...
unrealRootPath=/home/aaa/ue4
DisplayRootPath=/saturnv/simcore/sensors/display

gameProjectFile=/saturnv/simcore/sensors/display/Display.uproject
...
include(DisplaySource.pri)
include(DisplayHeader.pri)
include(DisplayConfig.pri)
include(DisplayIncludes.pri)
include(DisplayDefines.pri)
...
Display-Linux-Debug.commands = $$build Display Linux Debug  -project="\"$$gameProjectFile\"" $$args
Display-Linux-DebugGame.commands = $$build Display Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Display-Linux-Shipping.commands = $$build Display Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Display-Linux-Test.commands = $$build Display Linux Test  -project="\"$$gameProjectFile\"" $$args
Display.commands = $$build Display Linux Development  -project="\"$$gameProjectFile\"" $$args

DisplayEditor-Linux-Debug.commands = $$build DisplayEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DisplayEditor-Linux-DebugGame.commands = $$build DisplayEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DisplayEditor-Linux-Shipping.commands = $$build DisplayEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DisplayEditor-Linux-Test.commands = $$build DisplayEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DisplayEditor.commands = $$build DisplayEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	Display-Linux-Debug \
	Display-Linux-DebugGame \
	Display-Linux-Shipping \
	Display-Linux-Test \
	Display \
	DisplayEditor-Linux-Debug \
	DisplayEditor-Linux-DebugGame \
	DisplayEditor-Linux-Shipping \
	DisplayEditor-Linux-Test \
	DisplayEditor \
