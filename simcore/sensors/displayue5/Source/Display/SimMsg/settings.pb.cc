...
extern PROTOBUF_INTERNAL_EXPORT_settings_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Setting_SimMode_settings_2eproto;
namespace sim_msg {
...
class Setting_SimModeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Setting_SimMode> _instance;
} _Setting_SimMode_default_instance_;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Setting_settings_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsscc_info_Setting_settings_2eproto}, {
      ...
      &scc_info_Setting_SimMode_settings_2eproto.base,}};
...
static void InitDefaultsscc_info_Setting_SimMode_settings_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::sim_msg::_Setting_SimMode_default_instance_;
    new (ptr) ::sim_msg::Setting_SimMode();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::sim_msg::Setting_SimMode::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Setting_SimMode_settings_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_Setting_SimMode_settings_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_settings_2eproto[5];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_settings_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  1,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::sim_msg::Setting_SimMode, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::sim_msg::Setting_SimMode, sim_mode_type_),
  PROTOBUF_FIELD_OFFSET(::sim_msg::Setting_SimMode, ego_switch_time_),
  PROTOBUF_FIELD_OFFSET(::sim_msg::Setting_SimMode, traffic_switch_time_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::sim_msg::Setting, sim_mode_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 23, -1, sizeof(::sim_msg::Setting_SimMode)},
  { 31, -1, sizeof(::sim_msg::Setting)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::sim_msg::_Setting_SimMode_default_instance_),
...
const char descriptor_table_protodef_settings_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016settings.proto\022\007sim_msg\"\310\007\n\007Setting\022\017\n"
  ...
  "\027\n\017model3d_pathdir\030\021 \001(\t\022*\n\010sim_mode\030\022 \001"
  "(\0132\030.sim_msg.Setting.SimMode\032 \n\014ModuleCo"
  "nfig\022\020\n\010category\030\001 \001(\t\032K\n\024ParameterDecla"
  "ration\022\014\n\004name\030\001 \001(\t\022\026\n\016parameter_type\030\002"
  " \001(\t\022\r\n\005value\030\003 \001(\t\032O\n\016ModuleCfgEntry\022\013\n"
  "\003key\030\001 \001(\t\022,\n\005value\030\002 \001(\0132\035.sim_msg.Sett"
  "ing.ModuleConfig:\0028\001\032\325\001\n\007SimMode\022;\n\rsim_"
  "mode_type\030\001 \001(\0162$.sim_msg.Setting.SimMod"
  "e.SimModeType\022\027\n\017ego_switch_time\030\002 \001(\004\022\033"
  "\n\023traffic_switch_time\030\003 \001(\004\"W\n\013SimModeTy"
  "pe\022\013\n\007UNKNOWN\020\000\022\014\n\010WORLDSIM\020\001\022\n\n\006LOGSIM\020"
  "\002\022\r\n\tLOG2WORLD\020\003\022\022\n\016MANUAL_VEHICLE\020\004b\006pr"
  "oto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_settings_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_settings_2eproto_sccs[5] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_settings_2eproto = {
  &descriptor_table_settings_2eproto_initialized, descriptor_table_protodef_settings_2eproto, "settings.proto", 1004,
  &descriptor_table_settings_2eproto_once, descriptor_table_settings_2eproto_sccs, descriptor_table_settings_2eproto_deps, 5, 0,
  schemas, file_default_instances, TableStruct_settings_2eproto::offsets,
  file_level_metadata_settings_2eproto, 5, file_level_enum_descriptors_settings_2eproto, file_level_service_descriptors_settings_2eproto,
};
...
namespace sim_msg {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Setting_SimMode_SimModeType_descriptor() {
...
bool Setting_SimMode_SimModeType_IsValid(int value) {
  switch (value) {
    case 0:
    case 1:
    case 2:
...
constexpr Setting_SimMode_SimModeType Setting_SimMode::UNKNOWN;
constexpr Setting_SimMode_SimModeType Setting_SimMode::WORLDSIM;
constexpr Setting_SimMode_SimModeType Setting_SimMode::LOGSIM;
constexpr Setting_SimMode_SimModeType Setting_SimMode::LOG2WORLD;
constexpr Setting_SimMode_SimModeType Setting_SimMode::MANUAL_VEHICLE;
constexpr Setting_SimMode_SimModeType Setting_SimMode::SimModeType_MIN;
constexpr Setting_SimMode_SimModeType Setting_SimMode::SimModeType_MAX;
constexpr int Setting_SimMode::SimModeType_ARRAYSIZE;
...
void Setting_SimMode::InitAsDefaultInstance() {
}
class Setting_SimMode::_Internal {
 public:
};

Setting_SimMode::Setting_SimMode()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:sim_msg.Setting.SimMode)
}
Setting_SimMode::Setting_SimMode(const Setting_SimMode& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&ego_switch_time_, &from.ego_switch_time_,
    static_cast<size_t>(reinterpret_cast<char*>(&sim_mode_type_) -
    reinterpret_cast<char*>(&ego_switch_time_)) + sizeof(sim_mode_type_));
  // @@protoc_insertion_point(copy_constructor:sim_msg.Setting.SimMode)
}

void Setting_SimMode::SharedCtor() {
  ::memset(&ego_switch_time_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&sim_mode_type_) -
      reinterpret_cast<char*>(&ego_switch_time_)) + sizeof(sim_mode_type_));
}

Setting_SimMode::~Setting_SimMode() {
  // @@protoc_insertion_point(destructor:sim_msg.Setting.SimMode)
  SharedDtor();
}

void Setting_SimMode::SharedDtor() {
}

void Setting_SimMode::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Setting_SimMode& Setting_SimMode::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Setting_SimMode_settings_2eproto.base);
  return *internal_default_instance();
}


void Setting_SimMode::Clear() {
// @@protoc_insertion_point(message_clear_start:sim_msg.Setting.SimMode)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Setting_SimMode::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    CHK_(ptr);
    switch (tag >> 3) {
      // .sim_msg.Setting.SimMode.SimModeType sim_mode_type = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
          set_sim_mode_type(static_cast<::sim_msg::Setting_SimMode_SimModeType>(val));
        } else goto handle_unusual;
        continue;
      // uint64 ego_switch_time = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ego_switch_time_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          traffic_switch_time_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool Setting_SimMode::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:sim_msg.Setting.SimMode)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (8 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_sim_mode_type(static_cast< ::sim_msg::Setting_SimMode_SimModeType >(value));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:sim_msg.Setting.SimMode)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:sim_msg.Setting.SimMode)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void Setting_SimMode::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:sim_msg.Setting.SimMode)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // .sim_msg.Setting.SimMode.SimModeType sim_mode_type = 1;
  if (this->sim_mode_type() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnum(
      1, this->sim_mode_type(), output);
  }

  // uint64 ego_switch_time = 2;
  if (this->ego_switch_time() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(2, this->ego_switch_time(), output);
  }

  // uint64 traffic_switch_time = 3;
  if (this->traffic_switch_time() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(3, this->traffic_switch_time(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:sim_msg.Setting.SimMode)
}

::PROTOBUF_NAMESPACE_ID::uint8* Setting_SimMode::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:sim_msg.Setting.SimMode)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->sim_mode_type() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      1, this->sim_mode_type(), target);
  }

  // uint64 ego_switch_time = 2;
  if (this->ego_switch_time() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(2, this->ego_switch_time(), target);
  }

  // uint64 traffic_switch_time = 3;
  if (this->traffic_switch_time() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(3, this->traffic_switch_time(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sim_msg.Setting.SimMode)
  return target;
}

size_t Setting_SimMode::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sim_msg.Setting.SimMode)
  size_t total_size = 0;
  ...
  if (this->traffic_switch_time() != 0) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64Size(
        this->traffic_switch_time());
  }

  // .sim_msg.Setting.SimMode.SimModeType sim_mode_type = 1;
  if (this->sim_mode_type() != 0) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->sim_mode_type());
  }
...
void Setting_SimMode::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:sim_msg.Setting.SimMode)
  GOOGLE_DCHECK_NE(&from, this);
  const Setting_SimMode* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Setting_SimMode>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:sim_msg.Setting.SimMode)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:sim_msg.Setting.SimMode)
    MergeFrom(*source);
  }
}

void Setting_SimMode::MergeFrom(const Setting_SimMode& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sim_msg.Setting.SimMode)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  if (from.ego_switch_time() != 0) {
    set_ego_switch_time(from.ego_switch_time());
  }
  if (from.traffic_switch_time() != 0) {
    set_traffic_switch_time(from.traffic_switch_time());
  }
  if (from.sim_mode_type() != 0) {
    set_sim_mode_type(from.sim_mode_type());
  }
}

void Setting_SimMode::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:sim_msg.Setting.SimMode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Setting_SimMode::CopyFrom(const Setting_SimMode& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:sim_msg.Setting.SimMode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Setting_SimMode::IsInitialized() const {
  return true;
}

void Setting_SimMode::InternalSwap(Setting_SimMode* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(ego_switch_time_, other->ego_switch_time_);
  swap(traffic_switch_time_, other->traffic_switch_time_);
  swap(sim_mode_type_, other->sim_mode_type_);
}

::PROTOBUF_NAMESPACE_ID::Metadata Setting_SimMode::GetMetadata() const {
  return GetMetadataStatic();
}
...
void Setting::InitAsDefaultInstance() {
  ::sim_msg::_Setting_default_instance_._instance.get_mutable()->sim_mode_ = const_cast< ::sim_msg::Setting_SimMode*>(
      ::sim_msg::Setting_SimMode::internal_default_instance());
}
class Setting::_Internal {
 public:
  static const ::sim_msg::Setting_SimMode& sim_mode(const Setting* msg);
};

const ::sim_msg::Setting_SimMode&
Setting::_Internal::sim_mode(const Setting* msg) {
  return *msg->sim_mode_;
}
Setting::Setting()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
...
Setting::Setting(const Setting& from)
  ...
  if (from.has_sim_mode()) {
    sim_mode_ = new ::sim_msg::Setting_SimMode(*from.sim_mode_);
  } else {
    sim_mode_ = nullptr;
  }
...
void Setting::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete sim_mode_;
}
...
// @@protoc_insertion_point(message_clear_start:sim_msg.Setting)
  ...
  if (GetArenaNoVirtual() == nullptr && sim_mode_ != nullptr) {
    delete sim_mode_;
  }
  sim_mode_ = nullptr;
  _internal_metadata_.Clear();
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 17:
        ...
        continue;
      // .sim_msg.Setting.SimMode sim_mode = 18;
      case 18:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 146)) {
          ptr = ctx->ParseMessage(mutable_sim_mode(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void Setting::SerializeWithCachedSizes(
  ...
  // .sim_msg.Setting.SimMode sim_mode = 18;
  if (this->has_sim_mode()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      18, _Internal::sim_mode(this), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* Setting::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_sim_mode()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        18, _Internal::sim_mode(this), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:sim_msg.Setting)
  ...
  if (from.has_sim_mode()) {
    mutable_sim_mode()->::sim_msg::Setting_SimMode::MergeFrom(from.sim_mode());
  }
}
...
template<> PROTOBUF_NOINLINE ::sim_msg::Setting_SimMode* Arena::CreateMaybeMessage< ::sim_msg::Setting_SimMode >(Arena* arena) {
  return Arena::CreateInternal< ::sim_msg::Setting_SimMode >(arena);
}
