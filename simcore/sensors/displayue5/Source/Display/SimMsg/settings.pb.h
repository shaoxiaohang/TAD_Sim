...
class Setting_SimMode;
class Setting_SimModeDefaultTypeInternal;
extern Setting_SimModeDefaultTypeInternal _Setting_SimMode_default_instance_;
}  // namespace sim_msg
PROTOBUF_NAMESPACE_OPEN
...
template<> ::sim_msg::Setting_SimMode* Arena::CreateMaybeMessage<::sim_msg::Setting_SimMode>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace sim_msg {

enum Setting_SimMode_SimModeType : int {
  Setting_SimMode_SimModeType_UNKNOWN = 0,
  Setting_SimMode_SimModeType_WORLDSIM = 1,
  Setting_SimMode_SimModeType_LOGSIM = 2,
  Setting_SimMode_SimModeType_LOG2WORLD = 3,
  Setting_SimMode_SimModeType_MANUAL_VEHICLE = 4,
  Setting_SimMode_SimModeType_Setting_SimMode_SimModeType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Setting_SimMode_SimModeType_Setting_SimMode_SimModeType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool Setting_SimMode_SimModeType_IsValid(int value);
constexpr Setting_SimMode_SimModeType Setting_SimMode_SimModeType_SimModeType_MIN = Setting_SimMode_SimModeType_UNKNOWN;
constexpr Setting_SimMode_SimModeType Setting_SimMode_SimModeType_SimModeType_MAX = Setting_SimMode_SimModeType_MANUAL_VEHICLE;
constexpr int Setting_SimMode_SimModeType_SimModeType_ARRAYSIZE = Setting_SimMode_SimModeType_SimModeType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Setting_SimMode_SimModeType_descriptor();
template<typename T>
inline const std::string& Setting_SimMode_SimModeType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Setting_SimMode_SimModeType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Setting_SimMode_SimModeType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Setting_SimMode_SimModeType_descriptor(), enum_t_value);
}
inline bool Setting_SimMode_SimModeType_Parse(
    const std::string& name, Setting_SimMode_SimModeType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Setting_SimMode_SimModeType>(
    Setting_SimMode_SimModeType_descriptor(), name, value);
}
// ===================================================================
...
class Setting_SimMode :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sim_msg.Setting.SimMode) */ {
 public:
  Setting_SimMode();
  virtual ~Setting_SimMode();

  Setting_SimMode(const Setting_SimMode& from);
  Setting_SimMode(Setting_SimMode&& from) noexcept
    : Setting_SimMode() {
    *this = ::std::move(from);
  }

  inline Setting_SimMode& operator=(const Setting_SimMode& from) {
    CopyFrom(from);
    return *this;
  }
  inline Setting_SimMode& operator=(Setting_SimMode&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Setting_SimMode& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Setting_SimMode* internal_default_instance() {
    return reinterpret_cast<const Setting_SimMode*>(
               &_Setting_SimMode_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(Setting_SimMode& a, Setting_SimMode& b) {
    a.Swap(&b);
  }
  inline void Swap(Setting_SimMode* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Setting_SimMode* New() const final {
    return CreateMaybeMessage<Setting_SimMode>(nullptr);
  }

  Setting_SimMode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Setting_SimMode>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Setting_SimMode& from);
  void MergeFrom(const Setting_SimMode& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Setting_SimMode* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "sim_msg.Setting.SimMode";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  typedef Setting_SimMode_SimModeType SimModeType;
  static constexpr SimModeType UNKNOWN =
    Setting_SimMode_SimModeType_UNKNOWN;
  static constexpr SimModeType WORLDSIM =
    Setting_SimMode_SimModeType_WORLDSIM;
  static constexpr SimModeType LOGSIM =
    Setting_SimMode_SimModeType_LOGSIM;
  static constexpr SimModeType LOG2WORLD =
    Setting_SimMode_SimModeType_LOG2WORLD;
  static constexpr SimModeType MANUAL_VEHICLE =
    Setting_SimMode_SimModeType_MANUAL_VEHICLE;
  static inline bool SimModeType_IsValid(int value) {
    return Setting_SimMode_SimModeType_IsValid(value);
  }
  static constexpr SimModeType SimModeType_MIN =
    Setting_SimMode_SimModeType_SimModeType_MIN;
  static constexpr SimModeType SimModeType_MAX =
    Setting_SimMode_SimModeType_SimModeType_MAX;
  static constexpr int SimModeType_ARRAYSIZE =
    Setting_SimMode_SimModeType_SimModeType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  SimModeType_descriptor() {
    return Setting_SimMode_SimModeType_descriptor();
  }
  template<typename T>
  static inline const std::string& SimModeType_Name(T enum_t_value) {
    static_assert(::std::is_same<T, SimModeType>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function SimModeType_Name.");
    return Setting_SimMode_SimModeType_Name(enum_t_value);
  }
  static inline bool SimModeType_Parse(const std::string& name,
      SimModeType* value) {
    return Setting_SimMode_SimModeType_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  enum : int {
    kEgoSwitchTimeFieldNumber = 2,
    kTrafficSwitchTimeFieldNumber = 3,
    kSimModeTypeFieldNumber = 1,
  };
  // uint64 ego_switch_time = 2;
  void clear_ego_switch_time();
  ::PROTOBUF_NAMESPACE_ID::uint64 ego_switch_time() const;
  void set_ego_switch_time(::PROTOBUF_NAMESPACE_ID::uint64 value);

  // uint64 traffic_switch_time = 3;
  void clear_traffic_switch_time();
  ::PROTOBUF_NAMESPACE_ID::uint64 traffic_switch_time() const;
  void set_traffic_switch_time(::PROTOBUF_NAMESPACE_ID::uint64 value);

  // .sim_msg.Setting.SimMode.SimModeType sim_mode_type = 1;
  void clear_sim_mode_type();
  ::sim_msg::Setting_SimMode_SimModeType sim_mode_type() const;
  void set_sim_mode_type(::sim_msg::Setting_SimMode_SimModeType value);

  // @@protoc_insertion_point(class_scope:sim_msg.Setting.SimMode)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::uint64 ego_switch_time_;
  ::PROTOBUF_NAMESPACE_ID::uint64 traffic_switch_time_;
  int sim_mode_type_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_settings_2eproto;
};
...
class Setting :
 ...
 public:
  ...
  typedef Setting_SimMode SimMode;
  ...
  bool has_sim_mode() const;
  void clear_sim_mode();
  const ::sim_msg::Setting_SimMode& sim_mode() const;
  ::sim_msg::Setting_SimMode* release_sim_mode();
  ::sim_msg::Setting_SimMode* mutable_sim_mode();
  void set_allocated_sim_mode(::sim_msg::Setting_SimMode* sim_mode);
 ...
 private:
  ...
  ::sim_msg::Setting_SimMode* sim_mode_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_settings_2eproto;
};
// ===================================================================
...
// .sim_msg.Setting.SimMode.SimModeType sim_mode_type = 1;
inline void Setting_SimMode::clear_sim_mode_type() {
  sim_mode_type_ = 0;
}
inline ::sim_msg::Setting_SimMode_SimModeType Setting_SimMode::sim_mode_type() const {
  // @@protoc_insertion_point(field_get:sim_msg.Setting.SimMode.sim_mode_type)
  return static_cast< ::sim_msg::Setting_SimMode_SimModeType >(sim_mode_type_);
}
inline void Setting_SimMode::set_sim_mode_type(::sim_msg::Setting_SimMode_SimModeType value) {
  
  sim_mode_type_ = value;
  // @@protoc_insertion_point(field_set:sim_msg.Setting.SimMode.sim_mode_type)
}

// uint64 ego_switch_time = 2;
inline void Setting_SimMode::clear_ego_switch_time() {
  ego_switch_time_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Setting_SimMode::ego_switch_time() const {
  // @@protoc_insertion_point(field_get:sim_msg.Setting.SimMode.ego_switch_time)
  return ego_switch_time_;
}
inline void Setting_SimMode::set_ego_switch_time(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  ego_switch_time_ = value;
  // @@protoc_insertion_point(field_set:sim_msg.Setting.SimMode.ego_switch_time)
}

// uint64 traffic_switch_time = 3;
inline void Setting_SimMode::clear_traffic_switch_time() {
  traffic_switch_time_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Setting_SimMode::traffic_switch_time() const {
  // @@protoc_insertion_point(field_get:sim_msg.Setting.SimMode.traffic_switch_time)
  return traffic_switch_time_;
}
inline void Setting_SimMode::set_traffic_switch_time(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  traffic_switch_time_ = value;
  // @@protoc_insertion_point(field_set:sim_msg.Setting.SimMode.traffic_switch_time)
}
...
// .sim_msg.Setting.SimMode sim_mode = 18;
inline bool Setting::has_sim_mode() const {
  return this != internal_default_instance() && sim_mode_ != nullptr;
}
inline void Setting::clear_sim_mode() {
  if (GetArenaNoVirtual() == nullptr && sim_mode_ != nullptr) {
    delete sim_mode_;
  }
  sim_mode_ = nullptr;
}
inline const ::sim_msg::Setting_SimMode& Setting::sim_mode() const {
  const ::sim_msg::Setting_SimMode* p = sim_mode_;
  // @@protoc_insertion_point(field_get:sim_msg.Setting.sim_mode)
  return p != nullptr ? *p : *reinterpret_cast<const ::sim_msg::Setting_SimMode*>(
      &::sim_msg::_Setting_SimMode_default_instance_);
}
inline ::sim_msg::Setting_SimMode* Setting::release_sim_mode() {
  // @@protoc_insertion_point(field_release:sim_msg.Setting.sim_mode)
  
  ::sim_msg::Setting_SimMode* temp = sim_mode_;
  sim_mode_ = nullptr;
  return temp;
}
inline ::sim_msg::Setting_SimMode* Setting::mutable_sim_mode() {
  
  if (sim_mode_ == nullptr) {
    auto* p = CreateMaybeMessage<::sim_msg::Setting_SimMode>(GetArenaNoVirtual());
    sim_mode_ = p;
  }
  // @@protoc_insertion_point(field_mutable:sim_msg.Setting.sim_mode)
  return sim_mode_;
}
inline void Setting::set_allocated_sim_mode(::sim_msg::Setting_SimMode* sim_mode) {
  ...
  if (sim_mode) {
    ...
    if (message_arena != submessage_arena) {
      sim_mode = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sim_mode, submessage_arena);
    }
  ...
  sim_mode_ = sim_mode;
  // @@protoc_insertion_point(field_set_allocated:sim_msg.Setting.sim_mode)
}
...
template <> struct is_proto_enum< ::sim_msg::Setting_SimMode_SimModeType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::sim_msg::Setting_SimMode_SimModeType>() {
  return ::sim_msg::Setting_SimMode_SimModeType_descriptor();
}
