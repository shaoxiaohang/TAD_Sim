...
void AAnimalCharacter::Init(const FSimActorConfig& _Config)
{
    ...
    bool isEgoSnap = AnimalConfig->isEgoSnap;
    ...
    {
        NewTransform = FTransform(AnimalConfig->startRotation, AnimalConfig->startLocation);
    }
...
void AAnimalCharacter::Update(const FSimActorInput& _Input, FSimActorOutput& _Output)
{
    ...
    {
        NewTransform = FTransform(AnimalIn->rotation, AnimalIn->location);
    }
